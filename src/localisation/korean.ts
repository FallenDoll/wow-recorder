...
const KOREAN: Translations = {
  ...
  [Phrase.CloudUploadRetailDescription]: '소매용 녹화 영상을 클라우드에 업로드해야 하는 경우.',
  [Phrase.CloudUploadClassicDescription]: '클래식 녹음을 클라우드에 업로드해야 하는 경우.',
  ...
  [Phrase.CloudUploadRetailLabel]: '소매업 업로드',
  ...
  [Phrase.DownloadUploadDisabledDueToFilter]: "현재 선택된 저장소 필터로 인해 비활성화되었습니다.",
};
